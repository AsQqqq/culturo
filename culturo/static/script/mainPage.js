...
var switchDetailsButton = document.getElementById('details-button');

function stopDarkened(event) {
    event.stopPropagation();
}

switchDetailsButton.addEventListener('click', stopDarkened);